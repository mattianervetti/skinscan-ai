...
_ISTRUZIONE_DI_SISTEMA = (
    ...
    "2. Non rassicurare MAI sull'esito, in nessuna forma (vietate frasi come "
    ...
    "3. Il genere del paziente non è noto: NON usare MAI aggettivi, participi o "
    ...
    "4. Struttura fissa, in questo ordine: (a) cosa è emerso dalla valutazione, in "
    "termini di fattori considerati; (b) cosa succede adesso; (c) cosa deve fare "
    "concretamente il paziente come passo successivo.\n"
    "5. Ricorda sempre che la valutazione clinica finale spetta al dermatologo.\n"
    "6. Niente terminologia tecnica non spiegata.\n"
    "7. Massimo 5 frasi in tutto."
)
...
_TESTO_RISERVA_FOTO_SENZA_DERMATOLOGO = (
    ...
    "approfondire, pur non essendo stati segnalati cambiamenti in corso in alcun "
    "neo. Il passo successivo è l'invio di alcune fotografie guidate dei nei "
    "indicati. In base all'esito delle fotografie potrà essere richiesto un "
    "ulteriore approfondimento. Prosegua quindi con lo scatto guidato delle foto "
    "seguendo le istruzioni della piattaforma. La valutazione clinica finale "
    "spetta in ogni caso a un dermatologo."
)
_TESTO_RISERVA_FOTO_CON_DERMATOLOGO = (
    "Dalla valutazione del questionario sono emersi elementi che richiedono un "
    "approfondimento clinico. Il passo successivo è l'invio di alcune fotografie "
    "guidate dei nei indicati. Il caso sarà comunque esaminato da un dermatologo, "
    "a cui spetta ogni valutazione clinica. Prosegua quindi con lo scatto guidato "
    "delle foto seguendo le istruzioni della piattaforma. Riceverà "
    "successivamente indicazioni per una televisita."
)
